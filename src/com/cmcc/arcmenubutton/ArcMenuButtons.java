...
public class ArcMenuButtons extends RelativeLayout
{
	...
	public ArcMenuButtons(Context context, AttributeSet attrs)
	{
		...
		if (attrs != null)
		{
			...
			menuSrc = a.getResourceId(
					R.styleable.ArcMenu_menuSrc, 0);

			a.recycle();
		}
		Log.d(TAG, "AttributeSet ok");
	}
	...
	public void addItem(View item)
	{
		...
		if (sizePx > 0)
		{
			params = new RelativeLayout.LayoutParams(sizePx, sizePx);
		} else
		{
		...
		params.addRule(RelativeLayout.ALIGN_TOP, R.id.menu);
